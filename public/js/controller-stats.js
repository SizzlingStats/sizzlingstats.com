...
function StatsCtrl($scope, $rootScope, $route, $http, socket, resolvedData) {
  ...
  , ['DPM', 'Damage Per Minute', 'perMinute("totaldamage")']
  , ['DDPM', 'Damage Dealt Per Minute', 'perMinute("damagedone")']
  , ['DMG', 'Damage', 'sumOf("totaldamage")']
  , ['DD', 'Damage Dealt', 'sumOf("damagedone")']
